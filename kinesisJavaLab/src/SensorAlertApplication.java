...
public final class SensorAlertApplication {
    ...
    private static void init() {
        ...
        credentialsProvider = new ProfileCredentialsProvider("training");
        try {
...
//  }
        ...
        return clientConfig.withInitialPositionInStream(APPLICATION_INITIAL_POSITION_IN_STREAM)
...
//        return Solution.createWorker(config);
        ...
        IRecordProcessorFactory factory = new SensorRecordProcessorFactory();
        return new Worker(factory, config);
